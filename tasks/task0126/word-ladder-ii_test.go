...
func Test_findLadders(t *testing.T) {
	...
	assert.Equal(t, 2, len(findLadders(beginWord, endWord, wordList)))
}

func Test_findLadders2(t *testing.T) {
	beginWord := "hit"
	endWord := "cog"
...
func Test_findLadders3(t *testing.T) {
	beginWord := "red"
	endWord := "tax"
	wordList := []string{"ted", "tex", "red", "tax", "tad", "den", "rex", "pee"}
	assert.Equal(t, 3, len(findLadders(beginWord, endWord, wordList)))
}

func Test_findLadders4(t *testing.T) {
	beginWord := "qa"
	endWord := "sq"
	...
	assert.Equal(t,
		51,
		len(findLadders(beginWord, endWord, wordList)))
}

func Test_findLadders5(t *testing.T) {
	beginWord := "cet"
	endWord := "ism"
